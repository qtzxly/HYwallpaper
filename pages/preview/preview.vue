	...
	<view class="preview">
				...
				<scroll-view scroll-y="true">
					<view class="content">
						...
						<view class="row">
							...
							<text class="value" selectable="true" user-select="true">{{currentInfo.nickname}}</text>
						</view>
						...
						<view class="row">
							...
							<text class="value" selectable="true" user-select="true">{{currentInfo.description}}</text>
						</view>
		...
		<uni-popup ref="scorePopup" >
			<view class="scorePopup">
				...
				<view class="content">
					<uni-rate :disabled="isScore" disabled-color="#ffca3e" v-model="userScore" allow-half></uni-rate>
					<text class="text">{{userScore}}分</text>
				</view>

				<view class="footer">
					<button :disabled="!userScore|| isScore" type="default" size="mini" plain @click="submitScore">
						确认评分</button>
				</view>
